...
public class ArcFeature extends Feature implements MouseListener, MouseMotionListener, KeyListener {
	...
	public void mouseDragged(MouseEvent e) {
		...
		if (started) {
			if (
				sourceElement instanceof Place && targetElement instanceof Transition ||
				sourceElement instanceof Transition && targetElement instanceof Place
			) {
	...
	public void setElementColors(MouseEvent e, Map<Element, Color> elementColors) {
		...
		if (PNEditor.getInstance().getToolSelector().isSelectedTool_Arc()) {
			if (started) { // Connecting to something...
				if (!(targetElement instanceof  Node)) { // Connecting to air
...
//			else {
//				if (targetElement != null) {
//					elementColors.put(targetElement, Color.blue);
//				}
//			}
		}
	}
